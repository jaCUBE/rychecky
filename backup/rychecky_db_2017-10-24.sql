...
-- Vytvořeno: Úte 24. říj 2017, 20:02
...
CREATE TABLE IF NOT EXISTS `experience` (
  ...
  `added` timestamp NULL DEFAULT CURRENT_TIMESTAMP COMMENT 'Přidáno',
  `timestamp` timestamp NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT 'Změněno'
) ENGINE=InnoDB AUTO_INCREMENT=7 DEFAULT CHARSET=utf8 COLLATE=utf8_czech_ci ROW_FORMAT=COMPRESSED COMMENT='Seznam dovedností/znalostí';

--
-- Vypisuji data pro tabulku `experience`
--

INSERT INTO `experience` (`row_id`, `experience_id`, `type`, `title`, `company`, `date_start`, `date_end`, `detail`, `note`, `timeline`, `visible`, `added`, `timestamp`) VALUES
(1, 1, 'Zaměstnání', 'Operátor reaktorových smyček', 'Centrum výzkumu Řež s.r.o', '2011-01-01', '2014-05-01', 'Operátor experimentálních smyček výzkumného reaktoru LVR-15. Materiálový výzkum pro jaderné elektrárny na vodní, superkritické vodní a vysokoteplotní héliové smyčce…', 'Částečný úvazek při studiu. Pracovník se zdroji ionizujícího záření.', 1, 1, '2016-04-14 17:42:13', '2016-05-04 19:05:18'),
(2, 2, 'Zaměstnání', 'Aplikační specialista junior', 'Centrum výzkumu Řež s.r.o', '2013-07-01', '2017-10-31', 'Tvorba <a href="javascript:void(0)" onclick="portfolio(7)">robustního interního systému pro personální, finanční a projektové řízení</a>.\r\n<br />\r\nSpravování několika veřejných webů společnosti věnující se jaderné problematice.\r\n<br />\r\nRozdílné CMS, firemní komunikace, dotační programy EU…', 'Full Stack Employee', 1, 1, '2016-04-14 17:42:13', '2017-10-23 21:13:25'),
(3, 3, 'Vzdělání', 'Strojírenství se zaměřením na počítačové aplikace', 'Střední škola letecké a výpočetní techniky Odolena Voda', '2006-09-01', '2010-06-30', 'Střední škola letecké a výpočetní techniky v Odolene Vodě. Strojírenství, kostrukce, práce v CAD a CNC systémech a tvorba webových prezentací… Odmaturováno s vyznamenáním.', 'Odmaturováno s vyznamenáním.', 1, 1, '2016-04-14 17:42:13', '2016-05-05 19:40:38'),
(4, 4, 'Vzdělání', 'ZŠ Kralupy', 'Základní škola Jana Amose Komenského', '1996-09-01', '2006-06-30', 'Veřejná základní škola v Kralupech nad Vltavou', NULL, 0, 1, '2016-05-04 18:22:09', '2016-05-07 07:55:57'),
(5, 5, 'Vzdělání', 'ČVUT FBMI', 'ČVUT', '2010-10-01', '2013-02-01', 'Tři semestry bakalářského studia obooru Biomedicínská informatika. Nedokončeno.', 'nedokončeno', 0, 1, '2016-05-04 18:23:15', '2016-05-07 07:55:48'),
(6, 6, 'Zaměstnání', 'Administrativní práce na konstrukčím oddělení', 'ÚJV Řež, a. s.', '2009-07-01', '2009-08-01', 'Tvorba a kompletování výrobní dokumentace ke specializovaným strojírenským výrobkům.', 'Brigáda při studiu.', 0, 1, '2016-04-14 17:42:13', '2016-05-07 07:55:52');
...
(1, 1, 'Informační technologie', 100, 1, '2016-04-14 17:04:57', '2016-05-05 19:55:35'),
(2, 2, 'Sociální sítě', 80, 1, '2016-04-14 17:05:33', '2016-05-05 19:55:37'),
(3, 3, 'Seriály', 60, 1, '2016-04-14 17:05:46', '2016-05-05 19:55:39'),
(4, 4, 'Věda & technika', 80, 1, '2016-04-14 17:05:56', '2016-05-05 19:55:40'),
(5, 5, 'Četba & literatura', 80, 1, '2016-04-14 17:07:27', '2016-05-05 19:56:46'),
(6, 6, 'Webové technologie', 100, 1, '2016-04-14 17:07:38', '2016-05-05 19:55:44'),
(7, 7, 'Filmy', 70, 1, '2016-04-14 17:07:45', '2016-05-05 19:55:45'),
(8, 8, 'Mobilní telefony', 50, 1, '2016-04-14 17:07:56', '2016-05-05 19:55:46'),
(9, 9, 'Programování', 80, 1, '2016-04-14 17:08:06', '2016-05-05 19:55:48'),
(10, 10, 'Hudba', 70, 1, '2016-04-14 17:08:11', '2016-05-05 19:55:49'),
(11, 11, 'Hardware', 60, 1, '2016-04-14 17:08:18', '2016-05-05 19:55:51'),
(12, 12, 'Počítačové hry', 70, 1, '2016-04-14 17:08:24', '2016-05-05 19:55:52'),
(13, 13, 'Grafika & design', 60, 1, '2016-04-14 17:08:39', '2016-05-05 19:55:54'),
(14, 14, 'Počítačová bezpečnost', 70, 1, '2016-04-14 17:08:48', '2016-05-05 19:55:55'),
(15, 15, 'Fotografování', 60, 1, '2016-04-14 17:08:55', '2016-05-05 19:55:57'),
(16, 16, 'Anime', 50, 1, '2016-04-14 17:08:59', '2016-05-05 19:55:58'),
(17, 17, 'Tvorba titulků', 70, 1, '2016-05-04 16:57:06', '2016-05-05 19:56:00'),
(18, 18, 'Elektronika', 50, 1, '2016-04-14 17:08:59', '2016-05-05 19:55:58'),
(19, 19, 'Kryptografie', 40, 1, '2016-04-14 17:08:59', '2016-05-07 07:53:38'),
(20, 20, 'Kočky', 40, 1, '2016-04-14 17:08:59', '2016-05-07 07:53:39'),
(21, 21, 'Japonsko', 40, 1, '2016-05-05 20:11:03', '2016-05-05 20:11:06'),
(22, 22, 'Fyzika', 40, 1, '2016-05-07 07:53:30', '2016-05-07 07:53:34');
...
CREATE TABLE IF NOT EXISTS `info` (
  ...
  `added` timestamp NULL DEFAULT CURRENT_TIMESTAMP COMMENT 'Přidáno',
  `timestamp` timestamp NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT 'Změněno'
) ENGINE=InnoDB AUTO_INCREMENT=13 DEFAULT CHARSET=utf8 COLLATE=utf8_czech_ci ROW_FORMAT=COMPACT COMMENT='Tabulka se základními informacemi';
...
CREATE TABLE IF NOT EXISTS `news` (
  `row_id` int(11) NOT NULL COMMENT 'ID záznamu',
  `news_id` int(11) DEFAULT NULL COMMENT 'ID noinky',
  `text` text COLLATE utf8_czech_ci COMMENT 'Text novinky',
  `visible` int(11) NOT NULL DEFAULT '1' COMMENT 'Viditelný?',
  `added` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT 'Přidáno',
  `timestamp` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT 'Změněno'
...
INSERT INTO `news` (`row_id`, `news_id`, `text`, `visible`, `added`, `timestamp`) VALUES
(1, 1, 'Dělám si na kurz o technologii AngularJS, Grunt a Gulp. Učím se základy s Node.js.', 1, '2016-06-08 05:36:33', '2016-06-08 05:36:33');
...
(1, 1, 'Profesionální', 'Centrum výzkumu Řež s.r.o.', 'CVŘ', 'Dvojjazyčný robustní web prezentující společnost Centrum výzkumu Řež s.r.o., jenž se specializuje na jadernou energetiku. Stránky využívají nejmodernější technologie včetně mikroformátů a verze pro mobilní telefony. Je naplněn velkým množstvím informací o infrastruktuře společnosti a prováděném výzkumu zejména na poli jaderné energetiky. Bylo dbáno zejména na odbornou správnost. Web je postaven na systému Wordpress.', 'Obsáhlý web společnosti v oblasti jaderného výzkumu.', 'Centrum výzkumu Řež s.r.o.', 'http://cvrez.cz/', '2013-09-01', NULL, 60, NULL, 1, 1, 1, '2016-04-14 14:24:00', '2016-04-17 13:32:53'),
(2, 3, 'Profesionální', 'Enpedie: portál na podporu veřejné informovanosti v oblasti jaderné energetiky', 'Enpedie', 'Projekt společnosti Centrum výzkumu Řež s.r.o., který si klade za cíl pomocí wiki formátu udržovat a rozšiřovat informovanost o jaderné energetice. Hesla jsou vkládána a revidována odborníky na obor, tudíž jejich relevance je vyšší než z nevalidovaných zdrojů. Web je postaven na systému Mediawiki.', 'Wiki hesel s tématikou nejenom jaderné energetiky.', 'Centrum výzkumu Řež s.r.o.', 'http://enpedie.cz/', '2013-11-01', NULL, 30, NULL, 1, 1, 1, '2016-04-14 14:24:00', '2016-04-17 13:52:26'),
(22, 4, 'Profesionální', 'Fukušima', 'Fukušima: otázky', 'Projekt Státního úřadu pro jadernou bezpečnost (SÚJB) společně s Centrem výzkumu Řež s.r.o. Web vznikl na jaře 2011 jako bezprostřední reakce na havárii jaderné elektrárny Fukušima v Japonsku. Dotazy uživatelů kladené elektronicky zodpovídali uznávaní jaderní odborníci z celé republiky, včetně paní Drábové. Web je postaven na systému Drupal.', 'Dotazy a odpovědi k havárii Fukušimy v&nbsp;Japonsku.', 'Centrum výzkumu Řež s.r.o.', 'http://otazky-fukusima.cvrez.cz/', '2013-06-01', '2013-06-01', 30, NULL, 0, 1, 1, '2016-04-14 14:24:00', '2016-04-17 13:52:57'),
(23, 5, 'Osobní', 'Native Warez Forum', 'NWF', 'Projekt s téměř 45 tisíci návštěvami měsíčně (Google Analytics) a 80 tisíci registrovanými uživateli. Forum slouží pro sdílení souborů mezi uživateli. Systém SMF je silně modifikován vlastními unikátními doplňky. Velká komunita může NWF podporovat i na jeho stránkách na Facebooku a dalších sociálních sítích. Web je postaven na systému Simple Machines Forum (SMF).', 'Fórum pro sdílení souborů s téměr 80&nbsp;tisíci uživateli.', NULL, 'http://nwf.cz/', '2010-11-01', NULL, 70, NULL, 1, 1, 1, '2016-04-14 14:24:00', '2016-04-17 13:53:03'),
(24, 6, 'Profesionální', 'ELEXTERN: Electricity Externalities for Better Planning', 'ELEXTERN', 'Webový nástroj pro výpočet nákladů jednotlivých zdrojů energií elektrické energie. Systém započítává ceny externalit jako jsou náklady na léčbu rakoviny způsobené ozářením nebo cena půdy zabrané solárními elekrárnami. Tyto stránky využívají AJAX a Google Chart API.', 'Kalkulátor nákladů jednotlivých zdrojů elektřiny. Interaktivní znázornění v grafech.', NULL, 'http://elextern.eu/', '2015-01-01', NULL, 50, 'https://github.com/jaCUBE/elextern', 1, 1, 1, '2016-04-14 14:24:00', '2016-04-17 13:32:54'),
(25, 7, 'Profesionální', 'E2', 'CVŘ E2', '<p>Velký interní systém pro správu ~350 zaměstnanců a stovek projektů ve společnosti zabývající se jaderným výzkumem.</p>\r\n\r\n<p>\r\nVybrané funkce:\r\n<ul>\r\n<li>timesheet a využití vědecké infrastruktury včetně jaderných reaktorů,</li>\r\n<li>správa dovolených,</li>\r\n<li>komplexní management pracovních cest,</li>\r\n<li>databáze vědeckých publikací zaměstnanců,</li>\r\n<li>řízení rizik společnosti,</li>\r\n<li>management projektů včetně finančního řízení,</li>\r\n<li>přidělování a evidence úkolů...</li>\r\n</ul>\r\n</p>\r\n\r\n<p>V současnosti jde přibližně o 40 takovýchto <em>modulů</em>.</p>\r\n\r\n<p>Systém využívá zejména PHP, LESS, PDO, Bootstrap a další moderní technologie. Přes 700 commitů v git obsahuje stovky tříd a tisíce metod v bezmála 100 000 řádcích kódu.</p>\r\n\r\n<p>Databáze s více než miliónem záznamů pak obsluhuje v průměru dvanáct dotazů za sekundu.</p>', 'Robustní systém pro personální, projektové a finanční řízení vědecké organizace.', 'Centrum výzkumu Řež s.r.o.', 'http://e2.cvrez.cz/', '2015-01-01', NULL, 100, NULL, 1, 1, 1, '2016-04-14 14:24:00', '2016-09-07 18:55:42'),
(26, 8, 'Profesionální', 'Portál společnosti CVŘ', 'Interní portál CVŘ', 'Administrátorská správa portálu postaveného pod technologií Liferay.', 'Správa interního portálu na systému LifeRay.', 'Centrum výzkumu Řež s.r.o.', NULL, '2015-01-01', '2015-01-01', 30, NULL, 0, 0, 1, '2016-04-14 14:24:00', '2016-04-17 13:42:46'),
(27, 9, 'Profesionální', 'Web hotelu Na Plovárně v Humpolci', 'Hotel Na Plovárně', 'Menší webová prezentace hotelu na Vysočině.', 'Prezentace hotelu a restaurantu.', NULL, 'http://hotel-humpolec.cz/', '2014-10-01', '2014-10-01', 30, NULL, 0, 1, 1, '2016-04-14 14:24:00', '2016-09-07 17:16:47'),
(28, 10, 'Profesionální', 'Web překladatele Translatech', 'Translatech', 'Menší webová prezentace překladatelských služeb v oblasti jaderné energetiky.', 'Web odborného překladatele.', NULL, 'http://translatech.cz/', '2014-06-01', '2014-06-01', 30, NULL, 0, 1, 1, '2016-04-14 14:24:00', '2016-04-17 13:42:52'),
(29, 11, 'Osobní', 'ČSFD Extended Userscript', 'ČSFD Extended', NULL, 'Javascript do prohlížeče, který rozšiřuje funkce filmového serveru ČSFD.', NULL, 'https://greasyfork.org/cs/scripts/15784-%C4%8Csfd-extended', '2015-12-31', NULL, 20, 'https://github.com/jaCUBE/CSFD-Extended', 1, 1, 1, '2016-04-14 14:24:00', '2016-04-17 13:33:05'),
(30, 12, 'Osobní', 'Excel2SQL', 'Excel2SQL', NULL, 'Nástroj pro převod dat z tabulky Excel do&nbsp;SQL kódu.', NULL, 'http://excel2sql.rychecky.cz/', '2015-10-10', NULL, 30, 'https://github.com/jaCUBE/excel2sql', 1, 1, 1, '2016-04-14 14:24:00', '2016-04-17 13:53:20'),
(31, 13, 'Osobní', 'SRT Tool', 'SRT Tool', NULL, 'Utilita kontrolující typografii českých filmových titulků.', NULL, 'http://srt.rychecky.cz/', '2016-04-14', NULL, 20, NULL, 0, 1, 1, '2016-04-14 14:24:01', '2016-04-17 13:26:47'),
(32, 14, 'Profesionální', 'NUSIM 2014', 'NUSIM 2014', NULL, 'Web a registrační systém konference NUSIM 2014.', NULL, 'http://nusim2014.cz/', '2014-10-06', '2014-10-06', 30, NULL, 0, 0, 1, '2016-04-14 14:24:01', '2016-04-17 13:42:56'),
(33, 15, 'Profesionální', 'Pátý blok Dukovany', 'Pátý blok Dukovany', NULL, 'Web a registrační systém konference o jaderné elektrárně Dukovany.', 'EventEra', 'http://patyblokdukovany.cz/', '2015-01-09', '2015-01-09', 30, NULL, 0, 1, 1, '2016-04-14 14:24:01', '2016-04-17 13:42:57'),
(34, 16, 'Profesionální', 'Malé reaktory', 'Malé reaktory', NULL, 'Web a registrační systém konference Malé reaktory.', 'EventEra', 'http://malereaktory.cz/', '2016-01-12', '2016-01-12', 30, NULL, 0, 1, 1, '2016-04-14 14:24:01', '2016-04-17 13:42:59'),
(35, 17, 'Profesionální', 'Energochemie', 'Energochemie', NULL, 'Web a registrační systém 38. ročníku semináře Energochemie.', 'EventEra', 'http://energochemie.cz/', '2016-04-17', '2016-04-17', 30, NULL, 0, 1, 1, '2016-04-14 14:24:01', '2016-04-17 13:43:00'),
(36, 18, 'Profesionální', 'Horizon 2020 CORONA II', 'CORONA II', NULL, 'Web evropského projektu pro výuku jaderných reaktorů.', 'Centrum výzkumu Řež s.r.o.', 'http://corona2.eu/', '2015-11-17', NULL, 30, NULL, 0, 1, 1, '2016-04-14 14:24:01', '2016-04-17 13:22:58'),
(37, 19, 'Profesionální', 'Efektivní přenos poznatků v energetice', 'EPP Projekt', NULL, 'Stránky evropského projektu pro přenos poznatků.', 'Centrum výzkumu Řež s.r.o.', 'http://epp-projekt.cz/', '2013-11-17', '2013-11-17', 30, NULL, 0, 1, 1, '2016-04-14 14:24:01', '2016-09-07 17:17:04'),
(38, 20, 'Profesionální', 'Horizon 2020 VINCO', 'VINCO', NULL, 'Stránky projekty pro plynem chlazené reaktory.', 'Centrum výzkumu Řež s.r.o.', 'http://project-vinco.eu/', '2016-02-17', NULL, 30, NULL, 0, 1, 1, '2016-04-14 14:24:01', '2016-09-07 17:17:26'),
(39, 2, 'Profesionální', 'SUStainable ENergy (SUSEN)', 'SUSEN', 'Web velkého výzkumného projektu ve dvou jazycích. Projekt SUSEN představuje dotaci přes dvě miliardy korun, které posílí výzkumnou infrastrukturu v energetice České republiky a budou významným impulsem k rozvoji týmů, znalostí a technologií. Web obsahuje informace o programech a automatické zobrazování aktuálních výběrových řízení díky RSS kanálu.\nVzhledem připomíná mateřský web společnosti CVŘ, v jejíž režii se projekt SUSEN odehrává. Web je postaven na systému Wordpress.', 'Webová prezentace velkého výzkumného projektu Udržitelná energetika.', 'Centrum výzkumu Řež s.r.o.', 'http://susen2020.cz/', '2014-04-17', NULL, 40, NULL, 0, 1, 1, '2016-04-14 14:24:45', '2016-04-17 13:29:48');
...
(1, 1, 'Webdev', 'HTML', 80, 'Syntaxe jazyku HTML4 a XHTML. Znalost HTML 5 a zkušenosti s tvorbou sémantického webu (mikroformáty).', 1, '2016-04-14 14:14:51', '2016-05-07 08:57:49'),
(2, 2, 'Webdev', 'CSS + LESS', 80, 'Kaskádové styly a design webových stránek včetně moderního CSS3. Zkušenosti s využitím LESS.', 1, '2016-04-14 14:14:52', '2016-05-07 08:57:50'),
(3, 3, 'Webdev', 'PHP', 70, 'Ovládání skriptovacího jazyka PHP včetně objektově orientovaného programování (OOP).', 1, '2016-04-14 14:14:52', '2017-10-24 12:09:04'),
(4, 4, 'Webdev', 'SQL + MySQL', 60, 'Používání dotazovacího jazyka SQL. Návrh, správa a optimalizace open source databáze MySQL.', 1, '2016-04-14 14:14:52', '2016-05-07 08:57:53'),
(5, 5, 'Webdev', 'Javascript + jQuery', 60, 'Implementace Javascriptu do webu, zkušenosti s používáním knihoven jQuery a jQuery UI na reálných projektech.', 1, '2016-04-14 14:14:52', '2016-06-08 05:38:22'),
(6, 6, 'Webdev', 'SEO', 45, 'Optimalizace pro vyhledávače. Správná syntaxe při psaní kódu, vhodná struktura stránek a metrika návštěvnosti.', 1, '2016-04-14 14:14:52', '2016-05-07 08:57:58'),
(7, 7, 'Webdev', 'Sociální sítě', 50, 'Schopnost a zkušenost se správou známých sociálních sítí jako Facebook či YouTube. Základní povědomí o pravidlech a omezení, sledování novinek.', 1, '2016-04-14 14:14:52', '2016-04-14 18:49:15'),
(8, 8, 'Webdev', 'Apache (LAMP)', 20, 'Zkušenosti s konfigurací virtuálního privátního serveru (VPS) včetně instalace PHP, modulů do PHP…', 1, '2016-04-14 14:14:52', '2016-05-07 08:58:05'),
(9, 9, 'Webdev', 'CMS: SMF', 35, 'Bohaté zkušenosti se systémem Simple Machines Forum (SMF) pro internetová fóra. Znalost vnitřních procesů, psaní vlastních unikátních rozšíření…', 1, '2016-04-14 14:14:52', '2016-05-07 08:58:06'),
(10, 10, 'Webdev', 'CMS: Wordpress', 35, 'Dobrá znalost systému Wordpress z uživatelského i administrátorského hlediska.', 1, '2016-04-14 14:14:52', '2016-05-07 08:58:08'),
(11, 11, 'Webdev', 'CMS: MediaWiki', 20, 'Znalosti správy systému na bázi MediaWiki včetně konfigurace.', 1, '2016-04-14 14:14:52', '2016-05-07 08:58:12'),
(12, 12, 'Webdev', 'CMS: Drupal', 10, 'Základní znalost.', 1, '2016-04-14 14:14:52', '2016-05-07 08:58:13'),
(13, 13, 'Webdev', 'CMS: PHPBB', 10, 'Základní znalost.', 1, '2016-04-14 14:14:52', '2016-05-07 08:58:15'),
(14, 14, 'ICT', 'Photoshop', 60, 'Pokročilá znalost grafického programu Adobe Photoshop. Zkušenosti se zpracováním fotografií z formátu RAW.', 1, '2016-04-14 14:14:52', '2016-06-08 12:06:31'),
(15, 15, 'ICT', 'MS Office', 60, 'Dobrá znalost součástí balíku Microsoft Office.', 1, '2016-04-14 14:14:52', '2016-04-14 18:40:00'),
(16, 16, 'ICT', 'Sony Vegas', 20, 'Základní znalost střihu videa.', 1, '2016-04-14 14:14:52', '2016-04-14 18:40:03'),
(17, 17, 'ICT', 'Autocad + Inventor', 25, 'Základní znalost programu Autodesk AutoCAD a Autodesk Inventor.', 1, '2016-04-14 14:14:52', '2016-04-14 18:40:03'),
(18, 18, 'ICT', 'Bezpečnost', 45, 'Zájem o zabezpečení počítačů, sítí, webových stránek. Kryptografie, ochrana dat…', 1, '2016-04-14 14:14:52', '2016-04-14 18:40:01'),
(19, 19, 'ICT', 'Google', 60, 'Využívání a administrace dokumentů na Google Drive. Využívání Google Chart API pro vykreslování grafů.', 1, '2016-04-14 14:14:52', '2016-04-14 18:40:00'),
(20, 20, 'ICT', 'C# + .NET', 25, 'Základy objektového programování desktopových aplikací v C# za využití grafického rozhraní Windows a frameworku .NET.', 1, '2016-04-14 14:14:52', '2016-04-14 18:40:03'),
(21, 21, 'ICT', 'Matlab', 20, 'Základní znalost programovacího jazyka na bázi FORTRAN.', 1, '2016-04-14 14:14:53', '2016-04-14 18:40:03'),
(22, 22, 'ICT', 'Cinema 4D', 20, 'Základní znalost 3D modelování.', 1, '2016-04-14 14:14:53', '2016-04-14 18:40:04'),
(23, 23, 'ICT', 'Java', 15, 'Základní znalost.', 1, '2016-04-14 14:14:53', '2016-04-14 18:40:04'),
(24, 24, 'ICT', 'Hardware', 45, 'Znalost počítačových komponent a periferií.', 1, '2016-04-14 14:14:53', '2016-04-14 18:40:01'),
(25, 25, 'ICT', 'InDesign', 30, 'Lepší znalost programu pro sázení a typografickou úpravu, Adobe InDesign.', 1, '2016-04-14 14:14:53', '2016-04-14 18:40:01'),
(26, 26, 'ICT', 'Illustrator', 20, 'Základní znalost programu pro tvorbu vektorové grafiky, Adobe Illustrator.', 1, '2016-04-14 14:14:53', '2016-04-14 18:40:04'),
(27, 27, 'Jazyky', 'Čeština', 90, 'Znalost češtiny na pokročilé úrovni z hlediska gramatiky a stylistiky. Zkušenosti s proofreadingem a korekturou vědeckých textů.', 1, '2016-04-14 14:14:53', '2016-04-14 14:14:53'),
(28, 28, 'Jazyky', 'Angličtina', 70, 'Znalost angličtiny na úrovni upper-intermediate. Bezproblémová schopnost komunikovat i číst technickou dokumentaci.', 1, '2016-04-14 14:14:53', '2016-05-07 08:58:24'),
(29, 29, 'Ostatní', 'Marketing & PR', 30, 'Základní znalost firemní komunikace, zkušenosti s prací na oddělení komunikace vědecké společnosti.', 1, '2016-04-14 14:14:53', '2016-04-14 18:39:39'),
(30, 30, 'Ostatní', 'Jaderná energetika', 20, 'Základní fungování jaderného reaktoru. Zkušenost s prací se zdroji ionizujícího záření (pracovník kategorie A).', 1, '2016-04-14 14:14:53', '2016-04-14 18:39:39'),
(31, 31, 'Ostatní', 'Strojírenství', 15, 'Elementární znalost norem či konstrukce.', 1, '2016-04-14 14:14:53', '2016-04-14 18:39:39'),
(32, 32, 'Webdev', 'Git + GitHub', 25, 'Základní práce s verzovacím systémem Git a repozitáři na GitHubu.', 1, '2016-04-14 14:14:53', '2016-05-07 08:57:41'),
(33, 33, 'Webdev', 'Python', 10, 'Základní znalost programovacího jazyka Python.', 1, '2016-04-14 14:14:53', '2016-05-07 08:57:38'),
(34, 34, 'Ostatní', 'Fotografování', 40, 'Znalost práce s DSLR (zrcadlovka), principů a praxi fotografie včetně digitálních úprav.', 1, '2016-04-14 14:14:53', '2016-04-14 18:39:37'),
(35, 35, 'Webdev', 'AngularJS', 10, 'Základní znalost práce s Javascriptovým front-end frameworkem AngularJS.', 1, '2016-06-08 05:38:09', '2016-06-08 05:39:31'),
(36, 36, 'Webdev', 'Bootstrap', 50, 'Znalost frameworku Bootstrap a jeho nasazení na reálných webech.', 1, '2016-06-08 05:39:13', '2016-06-08 05:39:29'),
(37, 37, 'Webdev', 'Grunt', 10, 'Základní znalost task runneru Grunt.', 1, '2016-06-08 12:05:50', '2016-06-08 12:05:50');
...
--
ALTER TABLE `info`
  MODIFY `row_id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'ID záznamu',AUTO_INCREMENT=13;
--
-- AUTO_INCREMENT pro tabulku `news`
--
ALTER TABLE `news`
  MODIFY `row_id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'ID záznamu',AUTO_INCREMENT=2;
--
