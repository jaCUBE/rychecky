...
-- Exportování dat pro tabulku rychecky.certificate: ~1 rows (přibližně)
...
-- Exportování dat pro tabulku rychecky.experience: ~2 rows (přibližně)
...
INSERT INTO `portfolio` (`row_id`, `portfolio_id`, `type`, `name`, `name_short`, `detail`, `company`, `url`, `date_create`, `size`, `github`, `working`, `visible`, `added`, `timestamp`) VALUES
	...
	(25, 7, 'Profesionální', 'E2', 'Evidence pracovních aktivit E2', 'Velký interní systém pro správu zaměstnanců a personalistiku ve společnosti zaměřené na jaderný výzkum. Některé vybrané funkce systému: timesheet a přehledy i s grafy, správa dovolený s přehledem, komplexní management pracovních cest a konferencí, řízení rizik, systemizace pracovních míst, přidělování a evidence úkolů atd.  Systém využívá LESS, AJAX, PDO a další pokročilé technologie.Takřka rok práce na plný úvazek, přes 300 uživatelů (zaměstnanců), přes 300 commitů v Gitu, pět tisíc souborů, sto tabulek v databázi...', 'Centrum výzkumu Řež s.r.o.', 'http://e2.cvrez.cz/', '2015-01-01', 100, NULL, 1, 1, '2016-04-14 18:24:00', '2016-04-14 18:27:06'),
	...
	(30, 12, 'Osobní', 'Excel2SQL', NULL, NULL, NULL, 'http://excel2sql.rychecky.cz/', NULL, 30, 'https://github.com/jaCUBE/excel2sql', 1, 1, '2016-04-14 18:24:00', '2016-04-14 18:27:39'),
	(31, 13, 'Osobní', 'SRT Tool', NULL, NULL, NULL, 'http://srt.rychecky.cz/', '2016-04-14', 20, NULL, 1, 1, '2016-04-14 18:24:01', '2016-04-14 18:27:40'),
	(32, 14, 'Profesionální', 'NUSIM 2014', NULL, NULL, NULL, 'http://nusim2014.cz/', NULL, 0, NULL, 0, 1, '2016-04-14 18:24:01', '2016-04-14 18:27:40'),
	(33, 15, 'Profesionální', 'Pátý blok Dukovany', NULL, NULL, 'EventEra', 'http://patyblokdukovany.cz/', NULL, 0, NULL, 1, 1, '2016-04-14 18:24:01', '2016-04-14 18:27:40'),
	(34, 16, 'Profesionální', 'Malé reaktory', NULL, NULL, 'EventEra', 'http://malereaktory.cz/', NULL, 0, NULL, 1, 1, '2016-04-14 18:24:01', '2016-04-14 18:27:40'),
	(35, 17, 'Profesionální', 'Energochemie', NULL, NULL, 'EventEra', 'http://energochemie.cz/', NULL, 0, NULL, 1, 1, '2016-04-14 18:24:01', '2016-04-14 18:27:41'),
