...
-- Dumping data for table rychecky.image: ~28 rows (approximately)
...
-- Dumping data for table rychecky.portfolio: ~41 rows (approximately)
...
-- Dumping data for table rychecky.skill: ~74 rows (approximately)
